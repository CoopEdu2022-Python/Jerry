...
start_img = pygame.image.load('resources/images/dinosaur/7.png')
start_img = pygame.transform.scale(start_img, (60, 64))

game_over_img = pygame.image.load('resources/images/ending/game-over.png')
game_over_img = pygame.transform.scale(game_over_img, (200, 36))

replay_img = pygame.image.load('resources/images/ending/restart-6.png')
replay_img = pygame.transform.scale(replay_img, (40, 36))
replay_rect = replay_img.get_rect()
replay_rect.x = WIDTH // 2 - 20
replay_rect.y = 100

numbers_img = pygame.image.load('resources/images/scoreboard/numbers.png')
